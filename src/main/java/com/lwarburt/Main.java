...
public class Main extends PApplet {
    ...
    public static final double BODY_RADIUS = 6.37 * (Main.pow(10, 6)); //Radius of Earth = 6.37 * (Main.pow(10, 6)) (meters)
    ...
    public static double findCenter(){
        return Math.toDegrees(atan2((float) (0-yPos),(float) (0-xPos)));
    }
    ...
    public void draw() {
        //background(0);
        Vector2d velocity = new Vector2d(u0,0f);
